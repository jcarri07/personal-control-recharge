...
<?php 
$view = "../views/solicitud-create.php";
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        scriptElement.src = "../files/assets/js/solicitudes.js"; //Cambiar la ruta de la libreria.
        ...
        let styleElement = document.createElement("link");
            styleElement.href = "../files/assets/css/new-style.css";
            styleElement.rel = "stylesheet";
            document.head.appendChild(styleElement);
        // var scriptElement2 = document.createElement("script");
        // scriptElement2.src = "../files/assets/js/solicitudes-create.js"; //Cambiar la ruta de la libreria.

                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        while ($row = mysqli_fetch_array($query)) {
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><?php echo $sexo; ?></td>
                                                                                <td><?php echo $educacion != "" ? $educacion : "N/A"; ?>
                                                                                </td>
                                                                                <td>
                                                                                    <button class="btn btn-primary btn-table"
                                                                                        onclick="openModalEdit('<?php echo $id_hijo; ?>', '<?php echo $nombre; ?>', '<?php echo $fecha_nacimiento; ?>', '<?php echo $cedula; ?>', '<?php echo $sexo; ?>', '<?php echo $educacion; ?>', '<?php echo $talla_camisa; ?>', '<?php echo $talla_pantalon; ?>', '<?php echo $talla_calzado; ?>');">
                                                                                        <i class="feather icon-edit"></i>
                                                                                    </button>
                                                                                    <button class="btn btn-danger btn-table"
                                                                                        onclick="deseaEliminar('<?php echo $id_hijo; ?>');">
                                ...
                                <div class="col-md-12 text-center" style="margin-bottom: 0px;">
                                    <div class="box-title">
                                        <h3 class="modal-title text-center"
                                            style="margin-top: 0px; padding-top: 5px; padding-bottom: 5px;">Datos Personales
                                        </h3>
                                    </div>
                                    <div class="form-group row justify-content-center">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input name="ci" id="ci" type="number" class="required form-control"
                                                maxlength="30">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="block">Fecha de Nacimiento</label>
                                            <input name="birthday" id="birthday" type="date" class="form-control required"
                                                onchange="calculateAge('birthday','age')" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="block">Edad</label>
                                            <input name="ageEmployeer" id="age" type="text" class="form-control required"
                                                readonly>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="block">Sexo</label>
                                            <select class="form-control required" id="gender" name="gender"
                                                onchange="//womanInformation(this)" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input name="jeansSizes" id="jeansSizes" type="number" class="form-control"
                                                maxlength="10">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="shoesSizes" class="block">Talla de Calzado</label>
                                            <input name="shoesSizes" id="shoesSizes" type="number" class="form-control"
                                                maxlength="10">
                                        </div>
                                    </div>

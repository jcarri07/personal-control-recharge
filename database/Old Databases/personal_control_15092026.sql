...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-06-2024 a las 18:07:55
...
--
-- Base de datos: `personal_control`
--
...
--
-- Estructura de tabla para la tabla `datos_abae`
--
...
--
-- Estructura de tabla para la tabla `datos_hijos`
--
...
--
-- Estructura de tabla para la tabla `datos_vacaciones`
--
...
--
-- Estructura de tabla para la tabla `experiencia_instituciones_publicas`
--
...
--
-- Volcado de datos para la tabla `experiencia_instituciones_publicas`
--
...
--
-- Estructura de tabla para la tabla `formacion_exterior`
--
...
--
-- Volcado de datos para la tabla `formacion_exterior`
--
...
--
-- Estructura de tabla para la tabla `otros_datos_usuario`
--
...
(33, 35, 'Permisos', '', 'Diligencia Personales', '', '2024-06-10 04:00:00', '2024-06-14 04:00:00', '2024-06-07 16:37:45', '2024-06-07 16:37:45', 1, 'Dia Completo', 'pendiente', 'Rechazado por supervisor inmediato', 'rechazada', 33, 0, 1),
(34, 35, 'Reposo', '', 'Reposo por intervencion menor', '', '2024-06-17 04:00:00', '2024-06-21 04:00:00', '2024-06-07 17:24:42', '2024-06-07 17:24:42', 5, '', 'pendiente', '', 'pendiente', 33, 0, 1),
(35, 35, 'Permisos', 'APROBADO POR SIGH', 'Por Docencia', 'No remunerado', '2024-06-24 04:00:00', '2024-06-24 04:00:00', '2024-06-07 18:23:00', '2024-06-07 19:02:31', 1, 'Mediodia (Mañana)', 'aprobada', 'Aprobada por supervisor inmediato', 'aprobada', 33, 0, NULL);
...
(32, 'Jose Franzue', 'Carrizales Vargas', '24642009', '', 'jcarri07', '1234', 'empleado', 'activo', 31, 7, 'jcarrizales@abae.gob.ve'),
...
--
-- Indices de la tabla `datos_hijos`
--
...
--
-- Indices de la tabla `datos_vacaciones`
--
...
--
-- Indices de la tabla `experiencia_instituciones_publicas`
--
...
--
-- Indices de la tabla `formacion_exterior`
--
...
--
-- Indices de la tabla `otros_datos_usuario`
--
...
--
ALTER TABLE `datos_personales`
  MODIFY `id_datos_personales` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
...
--
ALTER TABLE `nivel_academico`
  MODIFY `id_nivel_academico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
-- Filtros para la tabla `datos_hijos`
--
ALTER TABLE `datos_hijos`
...
--
-- Filtros para la tabla `experiencia_instituciones_publicas`
--
ALTER TABLE `experiencia_instituciones_publicas`
  ADD CONSTRAINT `usuario_experiencia_publica` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`);

--
-- Filtros para la tabla `formacion_exterior`
--
ALTER TABLE `formacion_exterior`
...
--
-- Filtros para la tabla `otros_datos_usuario`
--
ALTER TABLE `otros_datos_usuario`

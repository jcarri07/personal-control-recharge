                                                        ...
                                                        <form id="form-edit" class="wizard-form">
                                                            ...
                                                            <div class="form-group row justify-content-center">
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input name="fecha_ingreso" id="fecha_ingreso"
                                                                        type="date" class="form-control"
                                                                        value="<?php echo $datos_abae['fecha_ingreso']; ?>"
                                                                        required>
                                                                </div>
                                                                <div class="col-md-4">
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <select class="form-control" id="cargo" name="cargo"
                                                                        required onchange="changeCargo();">
                                                                        <option value="">Seleccione</option>
                                                                        <!-- <option value="Presidente">Presidente</option> -->
                                                                        <!-- <option value="Vice-Presidente">Vice-Presidente</option> -->
                                                                        <option value="Director">Director</option>
                                                                        <option value="Jefe">Jefe</option>
                                                                        <option value="Personal de Investigacion">Personal
                                                                            de Investigacion</option>
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <select class="form-control" id="sede" name="sede"
                                                                        required onchange="changeSede();">
                                                                        <option value="">Seleccione</option>
                                                                        <?php
                                                                        while ($row = mysqli_fetch_array($querySedes)) {
                                                                            ?>
                                                                            <option value="<?php echo $row['id_sede']; ?>">
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <select class="form-control" id="unidad" name="unidad"
                                                                        required onchange="changeUnidad();">
                                                                        <option value="">Seleccione</option>
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <select class="form-control" id="supervisor_inmediato"
                                                                        name="supervisor_inmediato">
                                                                        <option value="">Seleccione</option>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <label class="block">Inicio en la Administración
                                                                        Pública</label>
                                                                    <input name="fecha_inicio_admin_publica"
                                                                        id="fecha_inicio_admin_publica" type="date"
                                                                        class="form-control"
                                                                        value="<?php echo $datos_abae['fecha_inicio_administracion']; ?>"
                                                                        required>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input name="correo" id="correo" type="text"
                                                                        class="form-control"
                                                                        value="<?php echo $datos_abae['correo_abae']; ?>"
                                                                        maxlength="100" required>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <label class="block">Teléfono Oficina / Ext.</label>
                                                                    <input name="telefono_oficina" id="telefono_oficina"
                                                                        type="text" class="form-control"
                                                                        value="<?php echo $datos_abae['tlf_oficina']; ?>"
                                                                        maxlength="40">
                                                                </div>

                                                                <div class="col-md-4">
                                                                    <label class="block">Posee Familiares en la ABAE</label>
                                                                    <select class="form-control" id="posee_familiares_abae"
                                                                        name="posee_familiares_abae" required
                                                                        onchange="changeFamiliaresAbae();">
                                                                        <option value="">Seleccione</option>
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <input name="nombre_familiares" id="nombre_familiares"
                    ...
                    <div class="page-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-block">
                                        <h2 class="text-center">Complete el registro de datos institucionales en <b>"Mis
                                                Datos"</b></h2>
                                    </div>
                                </div>
                            </div>

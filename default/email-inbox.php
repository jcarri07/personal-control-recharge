                        ...
                        <div class="pcoded-inner-content">
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    <p><strong>Error!</strong> No se pudo completar tu solicitud</p>
                                   </div> ";
                                    }
                                    ?>
                                    ...
                                    <div class="page-body">
                                        <div class="card">
                                            ...
                                            <div class="card-block email-card">
                                                ...
                                                <?php
                                                $todas = mysqli_query($conn, "SELECT COUNT(*) id_solicitud FROM solicitud");
                                                $value = mysqli_fetch_assoc($todas);

                                                //echo "<script>console.log('Console: " .$value['id_solicitud']. "' );</script>";
                                                $pendientes = mysqli_query($conn, "SELECT COUNT(*) id_solicitud FROM solicitud WHERE estatus = 'pendiente'");
                                                $value1 = mysqli_fetch_assoc($pendientes);

                                                $aprobadas = mysqli_query($conn, "SELECT COUNT(*) id_solicitud FROM solicitud WHERE estatus = 'aprobada'");
                                                $value2 = mysqli_fetch_assoc($aprobadas);

                                                $noaprobadas = mysqli_query($conn, "SELECT COUNT(*) id_solicitud FROM solicitud WHERE estatus = 'no aprobada'");
                                                    ...
                                                    <div class="col-lg-12 col-xl-3">
                                                        <div class="user-body">
                                                            <div class="p-20 text-center">
                                                                <a href="email-compose.php" class="btn btn-danger">Solicitar</a>
                                                            </div>
                                                                    ...
                                                                    <div class="mail-body-content">
                                                                        <div class="table-responsive">
                                                                            <table class="table">
                                                                                ...
                                                                                $query = mysqli_query($conn, "SELECT * FROM solicitud ORDER BY id_solicitud DESC")
                                                                                ...
                                                                                while ($data = mysqli_fetch_assoc($query)) {
                                                                                    ...
                                                                                    "
                                                                                        ...
                                                                                        <td>
                                                                                           ...
                                                                                           <td><a href='email-read.htm' class='email-name'>$data[tipo_solicitud]</a></td>
                                                                                           <td><a href='email-read.htm' class='email-name'>$data[observacion]</a></td>
                                                                                           <td><a href='email-read.htm' class='email-name'>$data[estatus]</a></td>
                                                                                           <td class='email-time'>$data[created_date]</td>
                                                                                           </tr>
                                                                                        ";
                                                                                }
                                                                                ?>
                                                                        ...
                                                                        <div class="table-responsive">
                                                                            <table class="table">
                                                                                <tr class="read">
                                                                                    ...
                                                                                    $query = mysqli_query($conn, "SELECT * FROM solicitud WHERE estatus= 'pendiente' ORDER BY id_solicitud DESC")
                                                                                        or die('error: ' . mysqli_error($conn));
                                                                    ...
                                                                    <div class="mail-body-content">
                                                                        <div class="table-responsive">
                                                                            <table class="table">
                                                                                ...
                                                                                $query = mysqli_query($conn, "SELECT * FROM solicitud WHERE estatus= 'no aprobada' ORDER BY id_solicitud DESC")
                                                                                    or die('error: ' . mysqli_error($conn));

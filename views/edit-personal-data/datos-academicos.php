                                                ...
                                                <div id="wizard">
                                                    <section>
                                                        ...
                                                        if (mysqli_num_rows($query) > 0) {
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <button class="btn btn-primary btn-table"
                                                                                        onclick="openModalEdit('<?php echo $id_nivel_academico; ?>', '<?php echo $especializacion; ?>', '<?php echo $titulo_obtenido; ?>', '<?php echo $anio_egreso; ?>', '<?php echo $instituto_universitario; ?>');">
                                                                                        <i class="feather icon-edit"></i>
                                                                                    </button>
                                                                                    <button class="btn btn-danger btn-table"
                                                                                        onclick="deseaEliminar('<?php echo $id_nivel_academico; ?>');">
                                                            ...
                                                            ?>
                                                            <h2 class="text-center mt-4">No hay niveles académicos registrados
                                                            </h2>
                                ...
                                <div class="col-md-12 text-center" style="margin-bottom: 0px;">
                                    <div class="box-title">
                                        <h3 class="modal-title text-center"
                                            style="margin-top: 0px; padding-top: 5px; padding-bottom: 5px;">Datos Académicos
                                        </h3>
                                    </div>
                                    <div class="form-group row justify-content-center">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <label class="block">Año de Grado</label>
                                            <input name="anio" id="anio" type="text" class="form-control" maxlength="10"
                                                required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="block">Institución Universitaria</label>
                    ...
                    <div class="page-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-block">
                                        <h2 class="text-center">Complete el registro de datos académicos en <b>"Mis
                                                Datos"</b></h2>
                                    </div>
                                </div>
                            </div>

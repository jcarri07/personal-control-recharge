                                                ...
                                                <div id="wizard">
                                                    <section>
                                                        ...
                                                        if (mysqli_num_rows($query) > 0) {
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <button class="btn btn-primary btn-table"
                                                                                        onclick="openModalEdit('<?php echo $id_formacion_exterior; ?>', '<?php echo $titulo_obtenido; ?>', '<?php echo $anio_egreso; ?>', '<?php echo $instituto_universitario; ?>', '<?php echo $pais; ?>');">
                                                                                        <i class="feather icon-edit"></i>
                                                                                    </button>
                                                                                    <button class="btn btn-danger btn-table"
                                                                                        onclick="deseaEliminar('<?php echo $id_formacion_exterior; ?>');">
                                                            ...
                                                            ?>
                                                            <h2 class="text-center mt-4">No hay ninguna formación en el exterior
                                                                registrada</h2>
                                ...
                                <div class="col-md-12 text-center" style="margin-bottom: 0px;">
                                    ...
                                    <div class="form-group row justify-content-center">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id="anio" name="anio" type="number" class="form-control" maxlength="10"
                                                required>
                                        </div>

                                        <div class="col-md-6">
                                            <label class="block">Institución Universitaria</label>
                                            <input name="instituto" id="instituto" type="text" class="form-control"
                                                maxlength="100" required>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control" id="pais" name="pais" required>
                                                ...
                                                while ($row = mysqli_fetch_array($queryPais)) {
                                                    ?>
                                                    <option value="<?php echo $row['pais']; ?>"><?php echo $row['pais']; ?>
                                                    </option>
                                                    <?php
                                                }
                                                ?>
                    ...
                    <div class="page-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-block">
                                        <h2 class="text-center">Complete el registro de formación en el exterior en <b>"Mis
                                                Datos"</b></h2>
                                    </div>
                                </div>
                            </div>

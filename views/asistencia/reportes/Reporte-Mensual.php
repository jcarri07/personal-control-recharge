...
//         LEFT JOIN actividad a ON u.id_usuario = a.id_usuario AND MONTH(a.fecha) = '$mes' AND a.estatus = 'A' AND YEAR(a.fecha) = '$Y'
//         WHERE i.estatus = 'A'  
...
<?php
        ...
        echo '<h2>Reporte de Asistencias del mes de ' . htmlspecialchars($a) . '</h2>'; 
?>

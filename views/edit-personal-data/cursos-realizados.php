...
$sql = "SELECT * FROM cursos_realizados WHERE id_usuario = '$idUser' AND estatus = 'activo';";
$query = mysqli_query($conn, $sql);
...
if ($datos_personales['step'] > 3) {
                                ...
                                <div class="page-header-breadcrumb">
                                    <ul class="breadcrumb-title">
                                        ...
                                        <li class="breadcrumb-item active">
                                            <a class="activate">Actualización de Datos / Cursos Realizados</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                ...
                                                <div id="wizard">
                                                    <section>
                                                        ...
                                                        if (mysqli_num_rows($query) > 0) {
                                                                ...
                                                                <table id="row-select" class="table table-striped table-bordered nowrap">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        while ($row = mysqli_fetch_array($query)) {
                                                                            $id_curso_realizado = $row['id_curso_realizado'];
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <button class="btn btn-primary btn-table"
                                                                                        onclick="openModalEdit('<?php echo $id_curso_realizado; ?>', '<?php echo addslashes(htmlspecialchars($nombre_curso)); ?>', '<?php echo addslashes(htmlspecialchars($duracion)); ?>', '<?php echo addslashes(htmlspecialchars($anio_curso)); ?>', '<?php echo addslashes(htmlspecialchars($instituto_universidad)); ?>', '<?php echo addslashes(htmlspecialchars($observaciones)); ?>');">
                                                                                        <i class="feather icon-edit"></i>
                                                                                    </button>
                                                                                    <button class="btn btn-danger btn-table"
                                                                                        onclick="deseaEliminar('<?php echo $id_curso_realizado; ?>');">
                                                            ...
                                                            ?>
                                                            <h2 class="text-center mt-4">No hay cursos registrados</h2>
                                                            <?php
                                                        }
                                                        ?>
                                                    </section>
                        ...
                        <div class="auth-box card-block">
                            <div class="row m-b-0">
                                <div class="col-md-12 text-center" style="margin-bottom: 0px;">
                                    <div class="box-title">
                                        <h3 class="modal-title text-center" style="margin-top: 0px; padding-top: 5px; padding-bottom: 5px;">Cursos Realizados</h3>
                                    </div>
    ...
    <script>
        ...
        function openModalAdd() {
            ...
            $("#aux_estatus").text("");
            $("#form-edit")[0].reset();
            $("#modal-form .modal-title").text("Añadir Curso Realizado");
        ...
        function openModalEdit(id, nombre_curso, duracion, anio_curso, instituto_universidad, observaciones) {
            ...
            $("#modal-form .modal-title").text("Editar Curso Realizado");
        ...
        $("#form-edit").on("submit", function (event) {
            ...
            datos.append('id_curso_realizado', $("#aux_id").text());
            ...
            $.ajax({
                url: '../modules/update-data-user/cursos-realizados-process.php',
                type: 'POST',
                data: datos,
                cache: false,
                contentType: false,

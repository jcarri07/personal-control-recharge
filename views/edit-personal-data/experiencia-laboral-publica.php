                                                    ...
                                                    <section>
                                                        <div class="text-center">
                                                            <button class="btn btn-primary"
                                                                onclick="openModalAdd();">Añadir</button>
                                                        </div>
                                                        <?php
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <button class="btn btn-primary btn-table"
                                                                                        onclick="openModalEdit('<?php echo $id_experiencia_instituciones_publicas; ?>', '<?php echo $organismo; ?>', '<?php echo $fecha_ingreso; ?>', '<?php echo $fecha_egreso; ?>', '<?php echo $cargo; ?>', '<?php echo $antecedentes_servicios; ?>');">
                                                                                        <i class="feather icon-edit"></i>
                                                                                    </button>
                                                                                    <button class="btn btn-danger btn-table"
                                                                                        onclick="deseaEliminar('<?php echo $id_experiencia_instituciones_publicas; ?>');">
                                                        ...
                                                        <?php
                                                            ...
                                                            ?>
                                                            <h2 class="text-center mt-4">No hay ninguna experiencia laboral
                                                                registrada</h2>
                                ...
                                <div class="col-md-12 text-center" style="margin-bottom: 0px;">
                                    <div class="box-title">
                                        <h3 class="modal-title text-center"
                                            style="margin-top: 0px; padding-top: 5px; padding-bottom: 5px;"></h3>
                                    </div>
                                    <div class="form-group row justify-content-center">

                                        <div class="col-md-12">
                                            <label class="block">Organismo</label>
                                            <input id="organismo" name="organismo" type="text" class="form-control"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input name="cargo" id="cargo" type="text" class="form-control" maxlength="50"
                                                required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="block">Posee Antecedentes de Servicios</label>
                                            <select class="form-control" id="antecedentes_servicios"
                                                name="antecedentes_servicios" required>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12 text-center aceptar" style="margin-bottom: 0px;">
                                            <button type="button" class="btn btn-secondary waves-effect" data-toggle="modal"
                                                data-target="#modal-form">Cerrar</button>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12 text-center aceptar" style="margin-bottom: 0px;">
                                            <button type="button" class="btn btn-primary waves-effect" data-toggle="modal"
                                                onclick="modify_estatus();">Aceptar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="page-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-block">
                                        <h2 class="text-center">Complete el registro de experiencia laboral en instituciones
                                            públicas en <b>"Mis Datos"</b></h2>
                                    </div>
                                </div>
                            </div>
                        </div>

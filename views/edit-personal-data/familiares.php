                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <button class="btn btn-primary btn-table"
                                                                                        onclick="openModalEdit('<?php echo $id_nucleo_familiar; ?>', '<?php echo $nombre; ?>', '<?php echo $apellido; ?>', '<?php echo $parentesco; ?>', '<?php echo $cedula; ?>', '<?php echo $fecha_nacimiento; ?>', '<?php echo $sexo; ?>', '<?php echo $estado_civil; ?>', '<?php echo $educacion; ?>');">
                                                                                        <i class="feather icon-edit"></i>
                                                                                    </button>
                                                                                    <button class="btn btn-danger btn-table"
                                                                                        onclick="deseaEliminar('<?php echo $id_nucleo_familiar; ?>');">
                    ...
                    <div class="page-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-block">
                                        <h2 class="text-center">Complete el registro de familiares en <b>"Mis Datos"</b>
                                        </h2>
                                    </div>
                                </div>
                            </div>
